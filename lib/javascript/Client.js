...
function genome_browser(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.get_gff = function (genome_ref, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "genome_browser.get_gff",
            [genome_ref], 1, _callback, _errorCallback);
    };
 
     this.get_fasta = function (genome_ref, _callback, _errorCallback) {
        if (typeof genome_ref === 'function')
            throw 'Argument genome_ref can not be a function';
        if (_callback && typeof _callback !== 'function')
            throw 'Argument _callback must be a function if defined';
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax(_url, "genome_browser.get_fasta",
            [genome_ref], 1, _callback, _errorCallback);
    };
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "genome_browser.status",
